...
EnumTranslations[SearchQueryTypes[SearchQueryTypes.min_aspect_ratio]] = $localize`Min aspect ratio`;
EnumTranslations[SearchQueryTypes[SearchQueryTypes.max_aspect_ratio]] = $localize`Max aspect ratio`;
